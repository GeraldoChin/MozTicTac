...
const ALL_PRODUCTS = [
  { name: "Relógio Premium Swiss Style", price: 4200, originalPrice: 5800, rating: 4.8, reviews: 124, city: "Maputo", province: "Maputo", category: "Acessórios", img: "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=400&q=80", badge: "Anúncio", isNew: true, hasDelivery: true, hasAffiliate: true, affiliatePct: 10, type: "produto" },
  { name: "Perfume Importado Chanel Nº5", price: 1850, originalPrice: 2400, rating: 4.6, reviews: 86, city: "Beira", province: "Sofala", category: "Acessórios", img: "https://images.unsplash.com/photo-1541643600914-78b084683702?w=400&q=80", badge: "Anúncio", isNew: false, hasDelivery: true, hasAffiliate: true, affiliatePct: 15, type: "produto" },
  { name: "Ténis Nike Air Max 2024", price: 3200, originalPrice: 4500, rating: 4.7, reviews: 54, city: "Nampula", province: "Nampula", category: "Sapatos", img: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=400&q=80", badge: null, isNew: true, hasDelivery: true, hasAffiliate: false, affiliatePct: 0, type: "produto" },
  { name: "Capulana Bordada Artesanal", price: 450, originalPrice: 650, rating: 4.9, reviews: 201, city: "Maputo", province: "Maputo", category: "Roupa", img: "https://images.unsplash.com/photo-1590735213920-68192a487bc2?w=400&q=80", badge: null, isNew: false, hasDelivery: false, hasAffiliate: true, affiliatePct: 12, type: "produto" },
  { name: "Samsung Galaxy A55 5G", price: 8900, originalPrice: 11000, rating: 4.5, reviews: 38, city: "Matola", province: "Maputo", category: "Celulares", img: "https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=400&q=80", badge: "Anúncio", isNew: true, hasDelivery: true, hasAffiliate: true, affiliatePct: 8, type: "produto" },
  { name: "Serviço de Cabeleireiro", price: 850, originalPrice: null, rating: 4.8, reviews: 312, city: "Maputo", province: "Maputo", category: "Serviços", img: "https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=400&q=80", badge: "Serviço", isNew: false, hasDelivery: false, hasAffiliate: false, affiliatePct: 0, type: "servico" },
  { name: "Auscultadores Sony XM5", price: 6200, originalPrice: 8500, rating: 4.9, reviews: 178, city: "Maputo", province: "Maputo", category: "Electrónicos", img: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=400&q=80", badge: null, isNew: true, hasDelivery: true, hasAffiliate: true, affiliatePct: 10, type: "produto" },
  { name: "Mochila Impermeável 30L", price: 1200, originalPrice: 1600, rating: 4.4, reviews: 67, city: "Beira", province: "Sofala", category: "Acessórios", img: "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=400&q=80", badge: null, isNew: false, hasDelivery: true, hasAffiliate: false, affiliatePct: 0, type: "produto" },
  { name: "Caju Torrado Embalado 1kg", price: 3200, originalPrice: 4000, rating: 4.8, reviews: 302, city: "Nacala", province: "Nampula", category: "Alimentos", img: "https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=400&q=80", badge: null, isNew: false, hasDelivery: true, hasAffiliate: true, affiliatePct: 20, type: "produto" },
  { name: "Sofá 3 Lugares Verde", price: 28000, originalPrice: 35000, rating: 4.3, reviews: 19, city: "Maputo", province: "Maputo", category: "Outros", img: "https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=400&q=80", badge: "Usado", isNew: false, hasDelivery: false, hasAffiliate: false, affiliatePct: 0, type: "produto" },
  { name: "Vestido Chitenge Tradicional", price: 1850, originalPrice: 2400, rating: 4.8, reviews: 124, city: "Maputo", province: "Maputo", category: "Roupa", img: "https://images.unsplash.com/photo-1594938298603-c8148c4b4832?w=400&q=80", badge: null, isNew: true, hasDelivery: true, hasAffiliate: true, affiliatePct: 12, type: "produto" },
  { name: "Anel de Ouro 18K Artesanal", price: 12800, originalPrice: 15000, rating: 4.7, reviews: 44, city: "Maputo", province: "Maputo", category: "Acessórios", img: "https://images.unsplash.com/photo-1617038260897-41a1f14a8ca0?w=400&q=80", badge: null, isNew: true, hasDelivery: false, hasAffiliate: false, affiliatePct: 0, type: "produto" },
];
...
export function FashionProducts({ onAddToCart }) {
  ...
  const [estado, setEstado]             = useState("todos");   // todos | novo | usado
  const [tipo, setTipo]                 = useState("todos");   // todos | produto | servico
          ...
          <div className="flex-1 min-w-0">
            {filtered.length === 0 ? (
              ...
              <div className={[
                ...
                {filtered.map((p, i) => (
                  <ProductCard key={i} p={p} onAddToCart={onAddToCart} />
                ))}
              </div>
            )}
          </div>
